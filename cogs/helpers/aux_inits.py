def     init_logger():
    ...
    base_logger = logging.getLogger("deerhunt")
    ...
    file_handler = RotatingFileHandler('deerhunt_all.log', 'a', 10000000, 10)
    file_handler.setFormatter(formatter)
    file_handler.setLevel(logging.DEBUG)
    base_logger.addHandler(file_handler)

    file_handler = RotatingFileHandler('deerhunt_errors.log', 'a', 1000000, 10)
    file_handler.setFormatter(formatter)
