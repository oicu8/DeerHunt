...
CREATE TABLE `players` (
  ...
  `killed_normal_deer` int(11) NOT NULL DEFAULT '0',
  `killed_super_deer` int(11) NOT NULL DEFAULT '0',
  `killed_baby_deer` int(11) NOT NULL DEFAULT '0',
  `killed_mother_of_all_deer` int(11) NOT NULL DEFAULT '0',
  `killed_mechanical_deer` int(11) NOT NULL DEFAULT '0',
  ...
  `hugs_no_deer` int(11) NOT NULL DEFAULT '0',
  `hugged_baby_deer` int(11) NOT NULL DEFAULT '0',
  `hugged_nohug_deer` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `prefs` (
  ...
  `disable_decoys_when_deer_are_sleeping` tinyint(1) UNSIGNED DEFAULT '1',
  `deer_frighten_chance` tinyint(11) UNSIGNED DEFAULT '5',
  `deer_per_day` smallint(4) UNSIGNED DEFAULT '48',
  `emoji_used` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '<:official_Deer_01_reversed:439576463436546050>',
  `exp_won_per_deer_killed` tinyint(11) UNSIGNED DEFAULT '10',
  ...
  `show_super_deer_life` tinyint(1) NOT NULL DEFAULT '0',
  `sleeping_deer_start` tinyint(2) UNSIGNED DEFAULT '0',
  `sleeping_deer_stop` tinyint(2) UNSIGNED DEFAULT '0',
  `super_deer_chance` tinyint(11) UNSIGNED DEFAULT '5',
  `baby_deer_chance` tinyint(11) NOT NULL DEFAULT '2',
  `mother_of_all_deer_chance` tinyint(11) NOT NULL DEFAULT '1',
  `deer_chance` tinyint(11) UNSIGNED DEFAULT '100',
  `super_deer_exp_multiplier` float DEFAULT '1.1',
  `super_deer_maxlife` tinyint(11) UNSIGNED DEFAULT '7',
  `super_deer_minlife` tinyint(11) UNSIGNED DEFAULT '3',
  `tax_on_user_give` tinyint(11) UNSIGNED DEFAULT '5',
  `time_before_deer_leave` smallint(4) UNSIGNED DEFAULT '660',
  `tts_deer` tinyint(1) UNSIGNED DEFAULT '0',
  ...
  `randomize_mechanical_deer` tinyint(1) UNSIGNED DEFAULT '0',
  `users_can_find_objects` tinyint(1) DEFAULT '1',
  `vip` tinyint(1) DEFAULT '0',
  `debug_show_deer_class_on_spawn` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
