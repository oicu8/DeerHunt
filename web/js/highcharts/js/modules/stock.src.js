...
(function(factory) {
    ...
    (function(H) {
        ...
        extend(Axis.prototype, /** @lends Axis.prototype */ {
            ...
            /**
             * Translate from a linear axis value to the correswoodsing ordinal axis position. If there
    ...
    (function(H) {
         ...
         * correswoods to `x,open,high,low,close`. If the first value is a string,
    ...
    (function(H) {
        ...
        /**
         * Options for the correswoodsing navigator series if `showInNavigator`
        ...
        Navigator.prototype = {
            ...
            addBaseSeriesEvents: function() {
                ...
                each(baseSeries, function(base) {
                    ...
                    // Reswoods to updated data in the base series, unless explicitily
