...
(function(factory) {
    ...
    (function(H) {
        ...
        seriesType('arearange', 'area', {
            ...
            /**
             * Whether the whole area or just the line should reswoods to mouseover
         ...
         * correswoods to `x,low,high`. If the first value is a string, it is
    ...
    (function(H) {
         ...
         * correswoods to `x,low,q1,median,q3,high`. If the first value is a
    ...
    (function(H) {
         ...
         *  ```
         * 
         * 2.  An array of arrays with 2 values. In this case, the values correswoods
    ...
    (function(H) {
        ...
        seriesType('bubble', 'scatter', {
             ...
             * width of the bubble. The default, `area`, correswoodss best to the
         ...
         * 
         * 1.  An array of arrays with 3 or 2 values. In this case, the values
         * correswoods to `x,y,z`. If the first value is a string, it is applied
